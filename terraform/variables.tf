...
variable "service_name" {
  ...
  type        = string
  default     = "flask-docker-api"
}


# This variable defines the ECR image Repo Name.
variable "ecs_image_repo_name" {
  description = "The desired ECR image Repo."
  type        = string
  default     = "replace_word_api"
}
...
variable "ecs_image_url" {
  ...
  type        = string
  default     = "705712192034.dkr.ecr.us-west-1.amazonaws.com/replace_word_api:latest"
